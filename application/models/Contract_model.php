...
{
	var $table = 'contract';
	var $column_order = array('id','nama_clien','tgl_mulai','tgl_akhir');
	var $order =  array('id','nama_clien','tgl_mulai','tgl_akhir');
	...
	private function _get_data_query(){
		...
		if(isset($_POST['search']['value'])){
			...
			$this->db->or_like('nama_clien', $_POST['search']['value']);
